...
const useStyles$c = reactJss.createUseStyles({
    checkbox: {
        '& *': {
...
const FontAwesomeIcon = (_a) => {
    ...
    return React.createElement(reactFontawesome.FontAwesomeIcon, Object.assign({}, props));
};

const useStyles$b = reactJss.createUseStyles({
    collapseWrapper: {
        display: 'flex',
        alignItems: 'stretch',
        '& .toggle-collapse': {
    ...
    return (React.createElement("div", { className: collapseClasses },
        React.createElement("div", { className: wrapperClasses },
            ...
            React.createElement("span", { className: 'toggle-collapse', onClick: (event) => {
                ...
                } }, props.toggleElement || (React.createElement(FontAwesomeIcon, { icon: props.isOpen ? freeSolidSvgIcons.faCaretDown : freeSolidSvgIcons.faCaretRight })))),
        React.createElement(reactstrap.Collapse, { isOpen: props.isOpen },
...
function FBRadioButton(props) {
    ...
    const [id] = React.useState(`radio-${Math.floor(Math.random() * 1000000)}`);
...
const useStyles$a = reactJss.createUseStyles({
    radio: {
        '& .fb-radio-button': {
            display: 'block',
            '& input[type="radio"]': {
...
const useStyles$9 = reactJss.createUseStyles({
    toolTip: {
        color: 'white',
...
function Example({ text, type, id, }) {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(reactstrap.UncontrolledTooltip, { autohide: false, className: classes.toolTip, placement: 'top', target: id }, text)));
}
...
function CardSelector({ possibleChoices, chosenChoices, onChange, placeholder, path, }) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("ul", null, chosenChoices.map((chosenChoice, index) => (React.createElement("li", { key: `${elementId}_neighbor_${index}` },
            chosenChoice,
            ' ',
            React.createElement(FontAwesomeIcon, { icon: freeSolidSvgIcons.faTimes, onClick: () => onChange([
...
const useStyles$8 = reactJss.createUseStyles({
    cardEnumOption: {
        width: '100%',
        display: 'flex',
        flexDirection: 'row',
...
function CardEnumOptions({ initialValues, names, showNames, onChange, type, }) {
    ...
    for (let index = 0; index < initialValues.length; index += 1) {
        ...
        possibleValues.push(React.createElement("div", { key: index, className: classes.cardEnumOption },
            React.createElement(reactstrap.Input, { value: value === undefined || value === null ? '' : value, placeholder: 'Possible Value', key: `val-${index}`, type: type === 'string' ? 'text' : 'number', onChange: (ev) => {
                    let newVal;
                    switch (type) {
                        case 'string':
            ...
            React.createElement(reactstrap.Input, { value: name || '', placeholder: 'Label', key: `name-${index}`, type: 'text', onChange: (ev) => {
                    if (names)
            ...
            React.createElement("div", { className: 'delete-button' },
                React.createElement(FontAwesomeIcon, { icon: freeSolidSvgIcons.faTimes, onClick: () => {
                        // remove this value
                        onChange([
                            ...initialValues.slice(0, index),
                            ...initialValues.slice(index + 1),
    ...
    return (React.createElement(React.Fragment, null,
        possibleValues,
        React.createElement(FontAwesomeIcon, { icon: freeSolidSvgIcons.faPlus, onClick: () => {
    ...
    if (possibility.value) {
        ...
        if (parentType === 'object') {
            ...
            const getInput = (val, index, key) => {
                switch (typeof val) {
                    case 'string':
                        return (React.createElement(reactstrap.Input, { value: val || '', placeholder: 'String value', type: 'text', onChange: (ev) => {
                    ...
                    case 'number':
                        return (React.createElement(reactstrap.Input, { value: val || '', placeholder: 'Number value', type: 'number', onChange: (ev) => {
                    ...
                    // @ts-ignore
                    case 'array':
                        return (React.createElement(reactstrap.Input, { value: JSON.stringify(val) || '', placeholder: 'Array in JSON', type: 'textarea', onChange: (ev) => {
                                let newVal = val;
                                try {
                    ...
                    case 'object':
                        return (React.createElement(reactstrap.Input, { value: JSON.stringify(val) || '', placeholder: 'Object in JSON', type: 'textarea', onChange: (ev) => {
                                let newVal = val;
                                try {
                                    newVal = JSON.parse(ev.target.value);
                                }
            ...
            return (React.createElement("div", null,
                enumArr.map((combination, index) => (React.createElement("li", { key: `${elementId}_possibleValue${index}` },
                    ...
                    React.createElement(FontAwesomeIcon, { icon: freeSolidSvgIcons.faTimes, onClick: () => onChange(Object.assign(Object.assign({}, possibility), { value: {
                                enum: [
                                    ...enumArr.slice(0, index),
                                    ...enumArr.slice(index + 1),
                                ],
...
function DependencyPossibility({ possibility, neighborNames, path, onChange, onDelete, parentEnums, parentType, parentName, parentSchema, }) {
    ...
    return (React.createElement("div", { className: 'form-dependency-condition' },
        ...
        React.createElement(FontAwesomeIcon, { icon: freeSolidSvgIcons.faTimes, onClick: () => onDelete() })));
}

const useStyles$7 = reactJss.createUseStyles({
    dependencyField: {
        '& .fa': { cursor: 'pointer' },
        '& .plus': { marginLeft: '1em' },
        '& h4': { marginBottom: '.5em' },
...
function DependencyField({ parameters, onChange, }) {
    ...
    return (React.createElement("div", { className: `form-dependency ${classes.dependencyField}` },
        ...
        React.createElement("div", { className: 'form-dependency-conditions' },
            ...
            React.createElement(reactstrap.UncontrolledTooltip, { placement: 'top', target: `${elementId}_adddependency` }, "Add another dependency relation linking this element and other form elements"))));
}

const useStyles$6 = reactJss.createUseStyles({
    cardModal: {
...
const CardModal = ({ componentProps, onChange, isOpen, onClose, TypeSpecificParameters, }) => {
    ...
    return (React.createElement(reactstrap.Modal, { isOpen: isOpen, "data-test": 'card-modal', className: classes.cardModal },
        React.createElement(reactstrap.ModalHeader, { className: 'card-modal-header' },
            React.createElement("div", { style: { display: componentProps.hideKey ? 'none' : 'initial' } },
                React.createElement("h3", null, "Additional Settings"))),
        React.createElement(reactstrap.ModalBody, { className: 'card-modal-entries' },
            ...
            React.createElement("div", null,
                ...
                React.createElement(reactstrap.Input, { value: componentPropsState['ui:column']
        ...
        React.createElement(reactstrap.ModalFooter, null,
            React.createElement(reactstrap.Button, { onClick: () => {
                    onClose();
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: 'card-entry-row' },
            showObjectNameInput && (React.createElement("div", { className: 'card-entry' },
                ...
                React.createElement(reactstrap.FormGroup, null,
                    React.createElement(reactstrap.Input, { invalid: keyError !== null, value: keyState || '', placeholder: 'Key', type: 'text', onChange: (ev) => setKeyState(ev.target.value), onBlur: (ev) => {
                    ...
                    React.createElement(reactstrap.FormFeedback, null, keyError)))),
            React.createElement("div", { className: `card-entry ${parameters.$ref === undefined ? '' : 'disabled-input'}` },
                ...
                React.createElement(reactstrap.Input, { value: titleState || '', placeholder: 'Title', type: 'text', onChange: (ev) => setTitleState(ev.target.value), onBlur: (ev) => {
        ...
        React.createElement("div", { className: 'card-entry-row' },
            React.createElement("div", { className: `card-entry ${parameters.$ref ? 'disabled-input' : ''}` },
                ...
                React.createElement(reactstrap.FormGroup, null,
                    React.createElement(reactstrap.Input, { value: descriptionState || '', placeholder: 'Description', type: 'text', onChange: (ev) => setDescriptionState(ev.target.value), onBlur: (ev) => {
...
const useStyles$5 = reactJss.createUseStyles({
    addDetails: {
        '& .popover': {
            width: '300px',
...
function Add({ addElem, hidden, tooltipDescription, labels, }) {
    ...
    const [createChoice, setCreateChoice] = React.useState('card');
    const [elementId] = React.useState(getRandomId());
    return (React.createElement("div", { style: { display: hidden ? 'none' : 'initial' } },
        React.createElement("span", { id: `${elementId}_add` },
            React.createElement(FontAwesomeIcon, { icon: freeSolidSvgIcons.faPlusSquare, onClick: () => setPopoverOpen(true) })),
        React.createElement(reactstrap.UncontrolledTooltip, { placement: 'top', target: `${elementId}_add` }, tooltipDescription || 'Create new form element'),
        React.createElement(reactstrap.Popover, { placement: 'bottom', target: `${elementId}_add`, isOpen: popoverOpen, toggle: () => setPopoverOpen(false), className: `add-details ${classes.addDetails}`, id: `${elementId}_add_popover` },
            React.createElement(reactstrap.PopoverHeader, null, "Create New"),
            React.createElement(reactstrap.PopoverBody, null,
                ...
                React.createElement("div", { className: 'action-buttons' },
                    React.createElement(reactstrap.Button, { onClick: () => setPopoverOpen(false), color: 'secondary' }, "Cancel"),
                    React.createElement(reactstrap.Button, { onClick: () => {
...
const useStyles$4 = reactJss.createUseStyles({
    headerDelete: {
        display: 'flex',
        '& .fa-trash': {
        ...
        React.createElement(Collapse, { isOpen: cardOpen, toggleCollapse: () => setCardOpen(!cardOpen), toggleElement: (_d = (_c = mods === null || mods === void 0 ? void 0 : mods.components) === null || _c === void 0 ? void 0 : _c.collapseToggle) === null || _d === void 0 ? void 0 : _d.call(_c, {
                ...
                React.createElement("span", { className: 'arrows' },
                    React.createElement("span", { id: `${elementId}_moveupbiginfo` },
                        React.createElement(FontAwesomeIcon, { icon: freeSolidSvgIcons.faArrowUp, onClick: () => (onMoveUp ? onMoveUp() : {}) })),
                    React.createElement(reactstrap.UncontrolledTooltip, { placement: 'top', target: `${elementId}_moveupbiginfo` }, "Move form element up"),
                    React.createElement("span", { id: `${elementId}_movedownbiginfo` },
                        React.createElement(FontAwesomeIcon, { icon: freeSolidSvgIcons.faArrowDown, onClick: () => (onMoveDown ? onMoveDown() : {}) })),
                    React.createElement(reactstrap.UncontrolledTooltip, { placement: 'top', target: `${elementId}_movedownbiginfo` }, "Move form element down"))), headerActions: React.createElement(React.Fragment, null, customDeleteButton || (React.createElement(React.Fragment, null,
                React.createElement("span", { className: classes.headerDelete, id: `${elementId}_trashbiginfo` },
                    React.createElement(FontAwesomeIcon, { icon: freeSolidSvgIcons.faClose, onClick: () => onDelete && onDelete() })),
                React.createElement(reactstrap.UncontrolledTooltip, { placement: 'top', target: `${elementId}_trashbiginfo` }, "Delete form element")))), className: `card-container ${componentProps.type || ''}-field ${componentProps.dependent ? 'card-dependent' : ''} ${componentProps.$ref === undefined ? '' : 'card-reference'}` },
            React.createElement("fieldset", { disabled: shouldDisableInputs, style: { border: 0, margin: 0, minWidth: 0, padding: 0 } },
                ...
                React.createElement("div", { className: classes.cardInteractions },
                    React.createElement("span", { id: `${elementId}_editinfo` },
                        React.createElement(FontAwesomeIcon, { icon: freeSolidSvgIcons.faPencilAlt, onClick: () => setModalOpen(true) })),
                    React.createElement(reactstrap.UncontrolledTooltip, { placement: 'top', target: `${elementId}_editinfo` }, "Additional configurations for this form element"),
...
const useStyles$3 = reactJss.createUseStyles({
    hidden: {
        display: 'none',
    },
});
...
const getInputCardBodyComponent = ({ type }) => function InputCardBodyComponent({ parameters, onChange, }) {
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(reactstrap.Input, { value: (parameters.default || ''), placeholder: 'Default', type: type, onChange: (ev) => onChange(Object.assign(Object.assign({}, parameters), { default: ev.target.value })), className: 'card-text' })));
};
...
function Section({ name, required, schema, uischema, onChange, onNameChange, onRequireToggle, onDependentsChange, onDelete, onMoveUp, onMoveDown, path, definitionData, definitionUi, hideKey, reference, dependents, dependent, parent, parentCardType, parentProperties, neighborNames, cardOpen, setCardOpen, allFormInputs, mods, categoryHash, }) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Collapse, { isOpen: cardOpen, toggleCollapse: () => setCardOpen(!cardOpen), toggleElement: (_d = (_c = mods === null || mods === void 0 ? void 0 : mods.components) === null || _c === void 0 ? void 0 : _c.collapseToggle) === null || _d === void 0 ? void 0 : _d.call(_c, {
                ...
                React.createElement("span", { className: classes.headerDelete, id: `${elementId}_trashbiginfo` },
                    React.createElement(FontAwesomeIcon, { icon: freeSolidSvgIcons.faClose, onClick: () => (onDelete ? onDelete() : {}) })),
                React.createElement(reactstrap.UncontrolledTooltip, { placement: 'top', target: `${elementId}_trashbiginfo` }, "Delete form element")))), className: `section-container ${classes.sectionContainer} ${dependent ? 'section-dependent' : ''} ${reference ? 'section-reference' : ''}` },
                ...
                React.createElement("div", { className: `section-entries ${reference ? 'section-reference' : ''}` },
                    React.createElement("div", { className: 'section-head' },
                        ...
                        React.createElement("div", { className: 'section-entry', "data-test": 'section-object-name' },
                            ...
                            React.createElement(reactstrap.FormGroup, null,
                                React.createElement(reactstrap.Input, { invalid: keyError !== null, value: keyName || '', placeholder: 'Key', type: 'text', onChange: (ev) => setKeyName(ev.target.value), onBlur: (ev) => {
                                        const { value } = ev.target;
                                        if (value === name ||
                        ...
                        React.createElement("div", { className: 'section-entry', "data-test": 'section-display-name' },
                            ...
                            React.createElement(reactstrap.Input, { value: schemaData.title || '', placeholder: 'Title', type: 'text', onChange: (ev) => onChange(Object.assign(Object.assign({}, schema), { title: ev.target.value }), uischema), className: 'card-text' })),
                        React.createElement("div", { className: 'section-entry', "data-test": 'section-description' },
                            ...
                            React.createElement(reactstrap.Input, { value: schemaData.description || '', placeholder: 'Description', type: 'text', onChange: (ev) => onChange(Object.assign(Object.assign({}, schema), { description: ev.target.value }), uischema), className: 'card-text' })),
                        React.createElement(reactstrap.Alert, { style: {
                    ...
                    React.createElement("div", { className: 'section-body' },
                        React.createElement(reactBeautifulDnd.DragDropContext, { onDragEnd: (result) => onDragEnd(result, {
                                schema,
                                uischema,
                                onChange,
                                definitionData,
                            ...
                            React.createElement(reactBeautifulDnd.Droppable, { droppableId: 'droppable' }, (providedDroppable) => (React.createElement("div", Object.assign({ ref: providedDroppable.innerRef }, providedDroppable.droppableProps),
                                generateElementComponentsFromSchemas({
                                    ...
                                    Card,
                                    Section,
                                }).map((element, index) => (React.createElement(reactBeautifulDnd.Draggable, { key: element.key, draggableId: element.key, index: index }, (providedDraggable) => (React.createElement("div", Object.assign({ ref: providedDraggable.innerRef }, providedDraggable.draggableProps, providedDraggable.dragHandleProps), element))))),
...
const PlaceholderInput = ({ parameters, onChange, }) => {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(reactstrap.Input, { value: parameters['ui:placeholder'] ? parameters['ui:placeholder'] : '', placeholder: 'Placeholder', key: 'placeholder', type: 'text', onChange: (ev) => {
...
const CardShortAnswerParameterInputs = ({ parameters, onChange, }) => {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement(reactstrap.Input, { value: parameters.minLength ? parameters.minLength : '', placeholder: 'Minimum Length', key: 'minLength', type: 'number', onChange: (ev) => {
        ...
        React.createElement(reactstrap.Input, { value: parameters.maxLength ? parameters.maxLength : '', placeholder: 'Maximum Length', key: 'maxLength', type: 'number', onChange: (ev) => {
        ...
        React.createElement(reactstrap.Input, { value: parameters.pattern ? parameters.pattern : '', placeholder: 'Regular Expression Pattern', key: 'pattern', type: 'text', onChange: (ev) => {
        ...
        React.createElement(reactstrap.Input, { value: parameters['ui:column'] ? parameters['ui:column'] : '', placeholder: 'Column size', key: 'ui:column', type: 'number', onChange: (ev) => {
...
const ShortAnswerField = ({ parameters, onChange }) => {
    return (React.createElement(React.Fragment, null,
        React.createElement("h5", null, "Default value"),
        React.createElement(reactstrap.Input, { value: parameters.default, placeholder: 'Default', type: formatTypeDictionary[parameters.format] || 'text', onChange: (ev) => onChange(Object.assign(Object.assign({}, parameters), { default: ev.target.value })), className: 'card-text' })));
};
const Password = ({ parameters, onChange }) => {
    return (React.createElement(React.Fragment, null,
        React.createElement("h5", null, "Default password"),
        React.createElement(reactstrap.Input, { value: parameters.default, placeholder: 'Default', type: 'password', onChange: (ev) => onChange(Object.assign(Object.assign({}, parameters), { default: ev.target.value })), className: 'card-text' })));
};
...
const LongAnswer = ({ parameters, onChange }) => {
    return (React.createElement(React.Fragment, null,
        React.createElement("h5", null, "Default value"),
        React.createElement(reactstrap.Input, { value: parameters.default, placeholder: 'Default', type: 'textarea', onChange: (ev) => onChange(Object.assign(Object.assign({}, parameters), { default: ev.target.value })), className: 'card-textarea' })));
};
...
const CardNumberParameterInputs = ({ parameters, onChange, }) => {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement(reactstrap.Input, { value: parameters.multipleOf ? parameters.multipleOf : '', placeholder: 'ex: 2', key: 'multipleOf', type: 'number', onChange: (ev) => {
        ...
        React.createElement(reactstrap.Input, { value: parameters.minimum || parameters.exclusiveMinimum || '', placeholder: 'ex: 3', key: 'minimum', type: 'number', onChange: (ev) => {
                let newVal = parseFloat(ev.target.value);
                if (Number.isNaN(newVal))
                    newVal = null;
        ...
        React.createElement(reactstrap.Input, { value: parameters.maximum || parameters.exclusiveMaximum || '', placeholder: 'ex: 8', key: 'maximum', type: 'number', onChange: (ev) => {
                let newVal = parseFloat(ev.target.value);
                if (Number.isNaN(newVal))
                    newVal = null;
...
const NumberField = ({ parameters, onChange }) => {
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(reactstrap.Input, { value: parameters.default, placeholder: 'Default', type: 'number', onChange: (ev) => onChange(Object.assign(Object.assign({}, parameters), { default: parseFloat(ev.target.value) })), className: 'card-number' })));
};
const numberInputs = {
    integer: {
        displayName: 'Integer',
...
const CardArrayParameterInputs = ({ parameters, onChange, }) => {
    return (React.createElement("div", null,
        ...
        React.createElement(reactstrap.Input, { value: parameters.minItems || '', placeholder: 'ex: 2', key: 'minimum', type: 'number', onChange: (ev) => {
        ...
        React.createElement(reactstrap.Input, { value: parameters.maxItems || '', placeholder: 'ex: 2', key: 'maximum', type: 'number', onChange: (ev) => {
        ...
        (!mods || mods.showFormHead !== false) && (React.createElement("div", { className: classes.formHead, "data-test": 'form-head' },
            React.createElement("div", null,
                React.createElement("h5", { "data-test": 'form-name-label' }, mods &&
                    ...
                    : 'Form Name'),
                React.createElement(reactstrap.Input, { value: schemaData.title || '', placeholder: 'Title', type: 'text', onChange: (ev) => {
            ...
            React.createElement("div", null,
                React.createElement("h5", { "data-test": 'form-description-label' }, mods &&
                    ...
                    : 'Form Description'),
                React.createElement(reactstrap.Input, { value: schemaData.description || '', placeholder: 'Description', type: 'text', onChange: (ev) => onChange(stringify(Object.assign(Object.assign({}, schemaData), { description: ev.target.value })), uischema), className: 'form-description' })))),
